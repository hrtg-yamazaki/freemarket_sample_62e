class Item < ApplicationRecord
  ...
  # validation
    validates :name           , presence: { message: "商品名 を入力してください" }        
                              , length: { maximum: 40, message: "商品名 は40文字以内で入力してください" }
    validates :text           , presence: { message: "商品の説明 を入力してください" }     
                              , length: { maximum: 1000, message: "商品の説明 は1000文字以内で入力してください" }
    ...
    validates :price          , presence: { message: "価格 を入力してください" }          
                              ...
                              , less_than_or_equal_to: 9999999, message: "価格 は300以上9999999以下の数字で入力してください" }
